...
export function ReceiveModal({ isOpen, onClose, walletAddress, onCopyAddress }: ReceiveModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Receive">
      <div className="text-center space-y-6">
        ...
        <div>
          <p className="text-xs tracking-widest uppercase mb-3" style={{ color: 'var(--text-tertiary)' }}>
            Your Address
          </p>
          <div
